...
#buyer_token = response.json()['message']['account']['auth_token']
#print("Buyer number : ",buyer)
#print("Buyer token : ", buyer_token)
print()
...
seller_token = response.json()['message']['account']['auth_token']
print("Seller number : ",seller)
print("Seller token : ", seller_token)
print()

headers = {'Content-Type': "application/json", 'Authorization' : buyer_token}
